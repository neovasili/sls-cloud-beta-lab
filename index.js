...
api.get('/api/v1/fakes', async (req, res) => {
  setTimeout(function () {
    res.send({
      message: "OK"
    })},
...
api.get('/api/v1/stages', async (req, res) => {
...
*/
api.get('/api/v1/todos', async (req, res) => {
...
*/
api.post('/api/v1/todos/:id', async (req, res) => {
...
*/
api.delete('/api/v1/todos/:id', async (req, res) => {
